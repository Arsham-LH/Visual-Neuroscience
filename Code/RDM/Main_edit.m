...
% NOTE: Be careful that trials which you missed but the answer is 0 (right)
% is considered as correct responses!!! B
% (See line 91) But they're excluded for computing accuracy
...
%trial parameters
num_trial       = 200; %34(Line 72) * 6(Number of coherence levels
escape          = KbName('q'); 
...
single_coherence    = [0.032, 0.064, 0.128, 0.256];     %coherence of the trials
...
condition           = repmat(single_coherence',num_trial/length(single_coherence),1);         %Repeat conditions to create needed trials for one block
